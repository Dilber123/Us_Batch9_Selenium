...
public class _01_SelectPractice extends BaseDriver{
     ...
     * Enter name, last name and email
     * Verify that an input is displayed that says enter your email again
     * And it wasn't there at the beginning
     * Re-enter your email
     * Create a password
     * Select Gender
...
//--------------Selecting random month
        ...
        selectMonth.selectByIndex(randomIndex);  //Jan=0 Dec =11
                                                 //numbers of months don't change . We don't need locator
...
//---------------Selecting random gender
        ...
        Assert.assertTrue(listOfSex.get(randomIndex).isSelected());
                                                                   //I just wanted to select the sex randomly
